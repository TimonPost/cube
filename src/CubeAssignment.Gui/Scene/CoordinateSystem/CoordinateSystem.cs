...
namespace CubeAssignment.Gui.Scene.CoordinateSystem
{
    ...
    public class CoordinateSystem : SceneObject
    {
        ...
        public CoordinateSystem(Renderer renderer)
        {
            _axises = new Axis[]
            {
                new Axis(renderer, "X", new Vector(1, 0, 0), Color.FromArgb(246, 54, 82)),
                new Axis(renderer, "Y", new Vector(0, 1, 0), Color.FromArgb(111, 162, 26)),
                new Axis(renderer, "Z", new Vector(0, 0, -1), Color.FromArgb(46, 131, 227))
            };
        }
